...
denisovan_odds_ratio = calculate_odds_ratio(snps_annotation_counts[[1]],snps_annotation_counts[[3]],'chrom_state')[,ancestry:='Denisova']
neanderthal_odds_ratio = calculate_odds_ratio(snps_annotation_counts[[2]],snps_annotation_counts[[3]],'chrom_state')[,ancestry:='Neanderthal']
...
names(chromHMM_palette) = unique(asnps_odds_ratio$elements)%>%stringr::str_sort(numeric = TRUE)
...
ggplot(asnps_odds_ratio, aes(x=factor(elements, level = chromstate_levels), y=odds_ratio,label = significance)) + 
...
denisovan_odds_ratio_celltype = calculate_odds_ratio(snps_counts_celltypes[[1]],snps_counts_celltypes[[3]],c('chrom_state','cell_type','cell_line'))[,ancestry:='Denisova']
neanderthal_odds_ratio_celltype = calculate_odds_ratio(snps_counts_celltypes[[2]],snps_counts_celltypes[[3]],c('chrom_state','cell_type','cell_line'))[,ancestry:='Neanderthal']
